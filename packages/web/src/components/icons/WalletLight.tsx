...
const SvgWalletLight = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    aria-hidden="true"
    data-prefix="fal"
    data-icon="wallet"
    className="wallet-light_svg__svg-inline--fa wallet-light_svg__fa-wallet wallet-light_svg__fa-w-16"
    viewBox="0 0 512 512"
    width="1em"
    height="1em"
    display="block"
